...
document.getElementById("check1").addEventListener("click",function(){
    ...
    const str1 = "저희는 지금 자바스크립트를 공부하고 있습니다.";
...
document.getElementById("check2").addEventListener("click", function(){
    ...
    div1.innerHTML += "/[abcd]/  ,  apple : " + regEx1.test("apple") + "<hr>"; // true
    div1.innerHTML += "/[abcd]/  ,  qwert : " + regEx1.test("qwety") + "<hr>"; // false
    
    // ^(캐럿) : 문자열의 시작을 의미 --> 왼쪽에 쓴다.
    const regEx2 = /^group/;
    div1.innerHTML += "/^group/  ,  group100 : " + regEx2.test("group100") + "<hr>"; //true
    div1.innerHTML += "/^group/  ,  100group : " + regEx2.test("100group") + "<hr>"; //false
